...
from .views import (
    ...
    RunDetailApiView,
    RunThumbnailApiView,
    RunsTrashCleanupApiView,
    RunsApiView,
    RunAssetApiView,
    WorkflowDebugApiView,
...
urlpatterns = [
    ...
    path("api/runs/trash-cleanup", RunsTrashCleanupApiView.as_view(), name="api-runs-trash-cleanup"),
    path("api/workflow-debug", WorkflowDebugApiView.as_view(), name="api-workflow-debug"),
