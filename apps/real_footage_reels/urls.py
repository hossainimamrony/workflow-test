...
from .views import (
    ...
    JobsApiView,
    MetaApiView,
    PublicStockVideoEndpointsApiView,
    PublicStockVideoHistoryApiView,
    PublicStockVideoLatestApiView,
    PublicStockVideoListApiView,
    RunDeleteApiView,
    RunDetailApiView,
    RunThumbnailApiView,
...
urlpatterns = [
    ...
    path("api/public/stock-videos/endpoints", PublicStockVideoEndpointsApiView.as_view(), name="api-public-stock-videos-endpoints"),
    path("api/public/stock-videos", PublicStockVideoListApiView.as_view(), name="api-public-stock-videos-list"),
    path("api/public/stock-videos/<str:stock_id>", PublicStockVideoLatestApiView.as_view(), name="api-public-stock-videos-latest"),
    path("api/public/stock-videos/<str:stock_id>/history", PublicStockVideoHistoryApiView.as_view(), name="api-public-stock-videos-history"),
]
